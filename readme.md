...
- [Production Readiness Checklist](https://github.com/MarinJursic/production-readiness-checklist) - Technology-neutral checks for reviewing architecture, operations, security, testing, and reliability before production.
## Bonus
